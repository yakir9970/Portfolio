  ...
  return (
    <div name='skills' className='w-full h-screen bg-[#0a192f] text-[#ccd6f6]'>
        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-[#ff9a63]'>Skills</p>
                <p className='py-4'>// These are the technologies I've worked with</p>
            </div>

            <div className='w-full grid grid-cols-2 md:grid-cols-4 gap-4 text-center py-8'>
                <div className='shadow-md shadow-[#535c74] hover:scale-110 duration-500'>
                ...
                <div className='shadow-md shadow-[#535c74] hover:scale-110 duration-500'>
                    <img src={GitHub} alt="github" className='w-20 mx-auto pt-4' />
